...
public class PlayRecordsUpdate
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PlayRecordsUpdate)) {
            return false;
        }
        PlayRecordsUpdate other = (PlayRecordsUpdate)o;
