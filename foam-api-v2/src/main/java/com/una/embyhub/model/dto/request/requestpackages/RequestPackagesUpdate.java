...
public class RequestPackagesUpdate
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestPackagesUpdate)) {
            return false;
        }
        RequestPackagesUpdate other = (RequestPackagesUpdate)o;
    ...
    public String toString() {
        return "RequestPackagesUpdate(id=" + this.getId() + ", title=" + this.getTitle() + ", description=" + this.getDescription() + ", count=" + this.getCount() + ", icon=" + this.getIcon() + ", amount=" + String.valueOf(this.getAmount()) + ")";
    }
}
