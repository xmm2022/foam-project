...
extends BaseEntity {
    ...
    public String toString() {
        return "NotifyTemplate(id=" + this.getId() + ", templateCode=" + this.getTemplateCode() + ", templateName=" + this.getTemplateName() + ", channelType=" + this.getChannelType() + ", templateContent=" + this.getTemplateContent() + ", variableComment=" + this.getVariableComment() + ", enabled=" + this.getEnabled() + ", remark=" + this.getRemark() + ")";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotifyTemplate)) {
            return false;
        }
        NotifyTemplate other = (NotifyTemplate)o;
