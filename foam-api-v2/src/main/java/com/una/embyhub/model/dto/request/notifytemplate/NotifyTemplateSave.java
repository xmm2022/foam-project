...
public class NotifyTemplateSave
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotifyTemplateSave)) {
            return false;
        }
        NotifyTemplateSave other = (NotifyTemplateSave)o;
    ...
    public String toString() {
        return "NotifyTemplateSave(templateCode=" + this.getTemplateCode() + ", templateName=" + this.getTemplateName() + ", channelType=" + this.getChannelType() + ", templateContent=" + this.getTemplateContent() + ", variableComment=" + this.getVariableComment() + ", enabled=" + this.getEnabled() + ", remark=" + this.getRemark() + ")";
    }
}
