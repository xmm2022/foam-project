...
public class MediaViewDetailSave
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaViewDetailSave)) {
            return false;
        }
        MediaViewDetailSave other = (MediaViewDetailSave)o;
