...
public class WeChatIpConfigUpdate
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WeChatIpConfigUpdate)) {
            return false;
        }
        WeChatIpConfigUpdate other = (WeChatIpConfigUpdate)o;
    ...
    public String toString() {
        return "WeChatIpConfigUpdate(id=" + this.getId() + ", corpId=" + this.getCorpId() + ", corpName=" + this.getCorpName() + ", appIds=" + this.getAppIds() + ", enabled=" + this.getEnabled() + ", remark=" + this.getRemark() + ")";
    }
}
