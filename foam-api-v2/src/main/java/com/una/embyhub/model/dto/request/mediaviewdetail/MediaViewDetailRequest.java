...
public class MediaViewDetailRequest
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaViewDetailRequest)) {
            return false;
        }
        MediaViewDetailRequest other = (MediaViewDetailRequest)o;
    ...
    public String toString() {
        return "MediaViewDetailRequest(id=" + this.getId() + ", mediaId=" + this.getMediaId() + ", userId=" + this.getUserId() + ", embyUserName=" + this.getEmbyUserName() + ", viewTime=" + this.getViewTime() + ", device=" + this.getDevice() + ", createDatetime=" + String.valueOf(this.getCreateDatetime()) + ", updateDatetime=" + String.valueOf(this.getUpdateDatetime()) + ", createUserName=" + this.getCreateUserName() + ", updateUserName=" + this.getUpdateUserName() + ", updateUserId=" + this.getUpdateUserId() + ", createUserId=" + this.getCreateUserId() + ", delFlag=" + this.getDelFlag() + ")";
    }
}
