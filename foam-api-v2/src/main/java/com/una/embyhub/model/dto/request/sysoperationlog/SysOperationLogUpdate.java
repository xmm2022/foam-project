...
public class SysOperationLogUpdate
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SysOperationLogUpdate)) {
            return false;
        }
        SysOperationLogUpdate other = (SysOperationLogUpdate)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SysOperationLogUpdate;
    }
    ...
    public String toString() {
        return "SysOperationLogUpdate(id=" + this.getId() + ", operationContent=" + this.getOperationContent() + ", operationType=" + this.getOperationType() + ", operationTime=" + String.valueOf(this.getOperationTime()) + ", operator=" + this.getOperator() + ", requestUrl=" + this.getRequestUrl() + ", requestMethod=" + this.getRequestMethod() + ", requestParams=" + this.getRequestParams() + ", responseResult=" + this.getResponseResult() + ", ipAddress=" + this.getIpAddress() + ", createDatetime=" + String.valueOf(this.getCreateDatetime()) + ", updateDatetime=" + String.valueOf(this.getUpdateDatetime()) + ", createUserName=" + this.getCreateUserName() + ", updateUserName=" + this.getUpdateUserName() + ", updateUserId=" + this.getUpdateUserId() + ", createUserId=" + this.getCreateUserId() + ", delFlag=" + this.getDelFlag() + ")";
    }
}
