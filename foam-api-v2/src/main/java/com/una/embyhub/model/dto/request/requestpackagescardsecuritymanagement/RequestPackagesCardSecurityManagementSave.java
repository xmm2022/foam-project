...
public class RequestPackagesCardSecurityManagementSave
implements Serializable {
    ...
    @Generated
    public RequestPackagesCardSecurityManagementSave() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestPackagesCardSecurityManagementSave)) {
            return false;
        }
        RequestPackagesCardSecurityManagementSave other = (RequestPackagesCardSecurityManagementSave)o;
