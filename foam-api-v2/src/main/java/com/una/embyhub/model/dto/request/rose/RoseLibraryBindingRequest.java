...
public class RoseLibraryBindingRequest
implements Serializable {
    ...
    @Generated
    public RoseLibraryBindingRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoseLibraryBindingRequest)) {
            return false;
        }
        RoseLibraryBindingRequest other = (RoseLibraryBindingRequest)o;
    ...
    public String toString() {
        return "RoseLibraryBindingRequest(libraryKey=" + this.getLibraryKey() + ", name=" + this.getName() + ", targetRoot=" + this.getTargetRoot() + ", targetRootName=" + this.getTargetRootName() + ", targetRootPath=" + this.getTargetRootPath() + ", enabled=" + this.getEnabled() + ")";
    }
}
