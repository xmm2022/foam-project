...
public class CardSecurityManagementUpdate
implements Serializable {
    ...
    @Generated
    public CardSecurityManagementUpdate() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CardSecurityManagementUpdate)) {
            return false;
        }
        CardSecurityManagementUpdate other = (CardSecurityManagementUpdate)o;
    ...
    public String toString() {
        return "CardSecurityManagementUpdate(id=" + this.getId() + ", cardPassword=" + this.getCardPassword() + ", cardValidity=" + this.getCardValidity() + ", cardStatus=" + this.getCardStatus() + ", createDatetime=" + String.valueOf(this.getCreateDatetime()) + ", updateDatetime=" + String.valueOf(this.getUpdateDatetime()) + ", createUserName=" + this.getCreateUserName() + ", updateUserName=" + this.getUpdateUserName() + ", updateUserId=" + this.getUpdateUserId() + ", createUserId=" + this.getCreateUserId() + ", delFlag=" + this.getDelFlag() + ")";
    }
}
