...
public class EmbyNotifyDataDetailsRequest
implements Serializable {
    ...
    @Generated
    public EmbyNotifyDataDetailsRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbyNotifyDataDetailsRequest)) {
            return false;
        }
        EmbyNotifyDataDetailsRequest other = (EmbyNotifyDataDetailsRequest)o;
