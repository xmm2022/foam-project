...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaMainRequest)) {
            return false;
        }
        MediaMainRequest other = (MediaMainRequest)o;
