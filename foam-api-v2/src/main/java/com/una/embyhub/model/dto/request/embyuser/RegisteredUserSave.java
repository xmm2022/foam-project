...
public class RegisteredUserSave
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RegisteredUserSave)) {
            return false;
        }
        RegisteredUserSave other = (RegisteredUserSave)o;
    ...
    public String toString() {
        return "RegisteredUserSave(embyUserId=" + this.getEmbyUserId() + ", embyUserName=" + this.getEmbyUserName() + ", embyUserPassword=" + this.getEmbyUserPassword() + ", isAdmin=" + this.getIsAdmin() + ", userStatus=" + this.getUserStatus() + ", expirationDate=" + String.valueOf(this.getExpirationDate()) + ", remarks=" + this.getRemarks() + ", requestPackagesCount=" + this.getRequestPackagesCount() + ", hostLineType=" + this.getHostLineType() + ", email=" + this.getEmail() + ", mobile=" + this.getMobile() + ", gender=" + this.getGender() + ", birthday=" + String.valueOf(this.getBirthday()) + ", interests=" + this.getInterests() + ", clientIp=" + this.getClientIp() + ")";
    }
}
