...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaMainUpdate)) {
            return false;
        }
        MediaMainUpdate other = (MediaMainUpdate)o;
