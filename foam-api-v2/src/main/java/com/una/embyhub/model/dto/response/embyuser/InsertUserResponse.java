...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsertUserResponse)) {
            return false;
        }
        InsertUserResponse other = (InsertUserResponse)o;
