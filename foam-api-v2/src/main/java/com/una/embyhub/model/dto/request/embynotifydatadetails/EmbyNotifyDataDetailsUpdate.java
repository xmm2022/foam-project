...
public class EmbyNotifyDataDetailsUpdate
implements Serializable {
    ...
    @Generated
    public EmbyNotifyDataDetailsUpdate() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbyNotifyDataDetailsUpdate)) {
            return false;
        }
        EmbyNotifyDataDetailsUpdate other = (EmbyNotifyDataDetailsUpdate)o;
