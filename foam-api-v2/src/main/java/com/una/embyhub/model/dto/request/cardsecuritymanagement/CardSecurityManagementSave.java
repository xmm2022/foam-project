...
public class CardSecurityManagementSave
implements Serializable {
    ...
    @Generated
    public CardSecurityManagementSave() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CardSecurityManagementSave)) {
            return false;
        }
        CardSecurityManagementSave other = (CardSecurityManagementSave)o;
    ...
    public String toString() {
        return "CardSecurityManagementSave(id=" + this.getId() + ", cardPassword=" + this.getCardPassword() + ", cardValidity=" + this.getCardValidity() + ", cardStatus=" + this.getCardStatus() + ", createDatetime=" + String.valueOf(this.getCreateDatetime()) + ", updateDatetime=" + String.valueOf(this.getUpdateDatetime()) + ", createUserName=" + this.getCreateUserName() + ", updateUserName=" + this.getUpdateUserName() + ", updateUserId=" + this.getUpdateUserId() + ", createUserId=" + this.getCreateUserId() + ", delFlag=" + this.getDelFlag() + ")";
    }
}
