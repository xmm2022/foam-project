...
public class EmbyIpLocationsSave
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbyIpLocationsSave)) {
            return false;
        }
        EmbyIpLocationsSave other = (EmbyIpLocationsSave)o;
