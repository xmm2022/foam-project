...
@TableName(value="points_exchange_product")
...
implements Serializable {
    ...
    public String toString() {
        return "PointsExchangeProduct(id=" + this.getId() + ", name=" + this.getName() + ", productType=" + this.getProductType() + ", pointsCost=" + this.getPointsCost() + ", productValue=" + this.getProductValue() + ", embyInfoId=" + this.getEmbyInfoId() + ", isEnabled=" + this.getIsEnabled() + ", sortOrder=" + this.getSortOrder() + ")";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PointsExchangeProduct)) {
            return false;
        }
        PointsExchangeProduct other = (PointsExchangeProduct)o;
