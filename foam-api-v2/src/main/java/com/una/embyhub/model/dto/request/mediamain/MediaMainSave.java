...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaMainSave)) {
            return false;
        }
        MediaMainSave other = (MediaMainSave)o;
