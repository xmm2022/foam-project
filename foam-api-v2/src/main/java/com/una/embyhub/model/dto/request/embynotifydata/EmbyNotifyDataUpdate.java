...
public class EmbyNotifyDataUpdate
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbyNotifyDataUpdate)) {
            return false;
        }
        EmbyNotifyDataUpdate other = (EmbyNotifyDataUpdate)o;
