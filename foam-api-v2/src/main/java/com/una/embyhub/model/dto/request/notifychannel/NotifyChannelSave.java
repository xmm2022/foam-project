...
public class NotifyChannelSave
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotifyChannelSave)) {
            return false;
        }
        NotifyChannelSave other = (NotifyChannelSave)o;
    ...
    public String toString() {
        return "NotifyChannelSave(name=" + this.getName() + ", desc=" + this.getDesc() + ", iconType=" + this.getIconType() + ", enabled=" + this.getEnabled() + ", customIcon=" + this.getCustomIcon() + ", params=" + this.getParams() + ")";
    }
}
