...
public class EmbyNotifyDataDetailsSave
implements Serializable {
    ...
    @Generated
    public EmbyNotifyDataDetailsSave() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EmbyNotifyDataDetailsSave)) {
            return false;
        }
        EmbyNotifyDataDetailsSave other = (EmbyNotifyDataDetailsSave)o;
