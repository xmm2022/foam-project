...
public class RequestPackagesCardSecurityManagementResponse
implements Serializable {
    ...
    @Generated
    public RequestPackagesCardSecurityManagementResponse() {
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RequestPackagesCardSecurityManagementResponse)) {
            return false;
        }
        RequestPackagesCardSecurityManagementResponse other = (RequestPackagesCardSecurityManagementResponse)o;
