...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HostLineSave)) {
            return false;
        }
        HostLineSave other = (HostLineSave)o;
    ...
    public String toString() {
        return "HostLineSave(embyInfoId=" + this.getEmbyInfoId() + ", lineName=" + this.getLineName() + ", lineType=" + this.getLineType() + ", protocol=" + this.getProtocol() + ", domain=" + this.getDomain() + ", port=" + this.getPort() + ", isDisplay=" + this.getIsDisplay() + ", enabled=" + this.getEnabled() + ", sortNo=" + this.getSortNo() + ", remark=" + this.getRemark() + ")";
    }
}
