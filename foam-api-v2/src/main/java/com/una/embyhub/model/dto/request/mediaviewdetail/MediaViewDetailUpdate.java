...
public class MediaViewDetailUpdate
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MediaViewDetailUpdate)) {
            return false;
        }
        MediaViewDetailUpdate other = (MediaViewDetailUpdate)o;
